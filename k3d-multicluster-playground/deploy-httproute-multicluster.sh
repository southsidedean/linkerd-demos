...
linkerd --context=k3d-cluster-a2 multicluster link --cluster-name cluster-a1 >> multicluster-link.yaml
linkerd --context=k3d-cluster-a3 multicluster link --cluster-name cluster-a1 >> multicluster-link.yaml
